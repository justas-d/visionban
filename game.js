...
`,
    ...
    // NOTE(justas): push order 2 & finish rule 1
`
....................
....................
.....@@@@@..........
...
`,
    ...
    // NOTE(justas): finish rule 3 & push order 3
`
...................
......@@@@@@@@.....
......@@@....@.....
...
`,
    ...
    // NOTE(justas): warehouse with lights 1 (needs redesign)
`
...................
.......@@@@@@......
.......@....@@@....
...
`,
    ...
    // NOTE(justas): warehouse with lights 2
`
....................
...@@@@@@@@@@@@@....
...@.....p.....@....
...
`,
    ...
    // NOTE(justas): warehouse with lights 3 & push order 4 & finish rule 4
...
function redraw(time) {
    ...
    if(is_loading) {
        ...
        if(state.current_level_index == 0) {
            ...
            blit_text(16, get_col(1), "Reset", cw * .5 - 25, ch * .5 + 45);
        }
        ...
        if(state.current_level_index == 11) {
            blit_img(images["win"], 7, 2);
            blit_img(images["thanks"], 6, 8);
        }
...
function update_key(e, is_down) {
    ...
    if(is_in_main_menu && main_menu_can_select && !is_loading) {
